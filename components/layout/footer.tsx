      ...
      <div className="max-w-screen-xl px-4 py-10 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 text-center">
          <div>
            ...
            <p className="mt-4 text-sm text-gray-600 justify-center items-center">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, accusantium.
            </p>
            <div className="flex mt-8 space-x-6 text-gray-600 justify-center items-center">
        ...
        <p className="flex mt-8 text-xs text-gray-800 justify-center">
          © 2024 Diego Lauricella
        </p>
      </div>
    </footer>
  );
